  ...
  <div class="card">
    <div class="card-header" id="headingTwo">
      <h5 class="mb-0">
        ...
        <button class="btn btn-link float-right" data-toggle="collapse" data-target="#collapseTwo" aria-expanded="false" aria-controls="collapseTwo">
         <Icon.ChevronDown/>
        </button>
      </h5>
    </div>
  ...
  <div class="card">
    <div class="card-header" id="headingThree">
      <h5 class="mb-0">
        ...
        <button class="btn btn-link float-right" data-toggle="collapse" data-target="#collapseThree" aria-expanded="false" aria-controls="collapseThree">
         <Icon.ChevronDown/>
        </button>
      </h5>
    </div>
  ...
  <div class="card">
    <div class="card-header" id="headingFour">
      <h5 class="mb-0">
        ...
        <button class="btn btn-link float-right" data-toggle="collapse" data-target="#collapseFour" aria-expanded="false" aria-controls="collapseFour">
         <Icon.ChevronDown/>
        </button>
      </h5>
    </div>
...
You can be infected by breathing in the virus if you are within 1 metre of a person who has COVID-19, or by touching a contaminated surface and then touching your eyes, nose or mouth before washing your hands.
  ...
  <div class="card-body">
    <h5 class="card-title">Source of information</h5>
    <p class="card-text">
    
    </p>
    <a href="https://www.who.int/" target="_blank" class=""> 
    <img class="" src="https://logos-download.com/wp-content/uploads/2016/12/World_Health_Organization_logo_logotype.png" alt="Who logo" style={{width:"80px",height:"25px"}}/>
    <Icon.ArrowUpRight/></a>
  </div>
</div>
